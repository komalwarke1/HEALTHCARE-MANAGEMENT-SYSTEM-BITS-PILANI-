...
export default function Bookappointment() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-green-100 p-6">
      <motion.div
      ...
      >
        {/* Header */}
        <div className="flex items-center justify-between bg-gradient-to-r from-blue-600 to-green-500 rounded-2xl p-6 text-white">
          <div className="flex items-center gap-6">
            ...
            <div>
              ...
              <p className="mt-1 text-green-100">Schedule your visit with our healthcare professionals</p>
            </div>
          </div>
        </div>

        <form onSubmit={handleSubmit} className="space-y-8">
          <ServiceSelection selectedService={selectedService} onServiceSelect={handleServiceSelect} />
          ...
          <PatientInformation patientInfo={patientInfo} setPatientInfo={setPatientInfo} />
            ...
            <button
              ...
              className={`px-8 py-3 rounded-full font-semibold text-lg transition-all ${
                isSubmitting || !selectedDate || !selectedTime || !selectedService || !selectedDoctor
                  ...
                  : "bg-gradient-to-r from-blue-600 to-green-500 hover:from-blue-700 hover:to-green-600 active:from-blue-800 active:to-green-700 text-white shadow-lg hover:shadow-xl"
              }`}
            >
