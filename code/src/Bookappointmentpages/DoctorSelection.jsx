...
const doctors = [
  {
    id: 1,
    name: "Dr. John Doe",
    specialties: ["General Checkup", "Vaccination"],
    rating: 4.8,
  ...
  },
  {
    id: 4,
    name: "Dr. Sarah Brown",
    specialties: ["Dental", "General Checkup"],
    rating: 4.6,
  ...
  },
  {
    id: 5,
    name: "Dr. David Lee",
    specialties: ["Laboratory", "Cardiology"],
    rating: 4.8,
...
export default function DoctorSelection({ selectedService, selectedDoctor, setSelectedDoctor }) {
  const availableDoctors = doctors.filter((doctor) => doctor.specialties.includes(selectedService))
